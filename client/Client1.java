...
public class Client1 {
    public static void main(String[] args) throws IOException {
        ...
        Subscriber sub3 = new Subscriber(3, null, 0, 0, null, false);
        Subscriber sub4 = new Subscriber(4,"Toprak Yavuz",16310202,163200,Arrays.asList("Surfing Net", "Coding" , "Tennis"),true
        );

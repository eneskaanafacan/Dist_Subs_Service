...
public class Server2 {
    public static void main(String[] args){
        ...
        try {
            ...
            ServerSocket clientserverSocket = new ServerSocket(9992);
            System.out.println("Merhaba Server2");
            
            // Admin server Socket
            List<Subscriber> subscribers = new ArrayList<>();
            ServerSocket adminserverSocket = new ServerSocket(9996);
...
class Demand {
    ...
    private String sendCpcty(ObjectOutputStream out) throws IOException {
        if(capacity.showCapacity() == 0){
            out.writeObject("server2_status : "+ capacity.showCapacity() + "\ntimestamp : " + System.currentTimeMillis() );
            return "null";
        }
        else
            out.writeObject("server2_status : " + capacity.showCapacity() + "\ntimestamp : " + System.currentTimeMillis() );

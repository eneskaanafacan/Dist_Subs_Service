...
public class Server1 {
    public static void main(String[] args){
        ...
        try {
            ...
            ServerSocket clientserverSocket = new ServerSocket(9991);
            System.out.println("Merhaba Server1");
            
            // Admin server Socket
            List<Subscriber> subscribers = new ArrayList<>();
            ServerSocket adminserverSocket = new ServerSocket(9995);
...
class Demand {
    ...
    private String sendCpcty(ObjectOutputStream out) throws IOException {
        if(capacity.showCapacity() == 0){
            out.writeObject("server1_status : "+ capacity.showCapacity() + "\ntimestamp : " + System.currentTimeMillis() );
            return "null";
        }
        else
            out.writeObject("server1_status : " + capacity.showCapacity() + "\ntimestamp : " + System.currentTimeMillis() );
